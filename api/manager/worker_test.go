...
func (p dowloaderMock) DownloadURL(ctx context.Context, db scan.Queryer, url *model.URL) (string, error) {
...
func (s storeMock) LockURL(ctx context.Context, db scan.Queryer, url *model.URL) error {
	return nil
}

func (s storeMock) UnlockURL(ctx context.Context, db scan.Queryer, url *model.URL) error {
	return s.unlockURLFunc(ctx, url)
}

func (s storeMock) SetOEmbed(ctx context.Context, db scan.Queryer, url *model.URL) error {
	return nil
}
