...
type Store interface {
	AppendLog(ctx context.Context, db nest.Querier, urlID int64, log *model.Log) error
}
...
func (p *Downloader) DownloadURL(ctx context.Context, db nest.Querier, url *model.URL) (string, error) {
